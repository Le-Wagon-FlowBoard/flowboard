...
user2 = User.create!(email: 'benjamin@pizzeria.com', password: 'password', first_name: 'Benjamin', last_name: 'Barillot')
user3 = User.create!(email: 'josue@pizzeria.com', password: 'password', first_name: 'Josué', last_name: 'de Almeida Rodrigues')
